...
$query = "SELECT * FROM goods WHERE good_type_id=2";
...
<a href="agriculture.php">Agricultural</a> | <A HREF="#other service">Electronic</a> | <A HREF="#fuel">Household</a> |<A HREF="#carservice">machinery</a>| <A HREF="#other service">Traditional Artifacts</a>  |
            ...
            <table class="table table-bordered">
                ...
                <tr>
                   ...
                   <td><?php echo $article['good_price'] ?></td>
                   ...
                   <td><div class="el-card-item">
                    ...
                    <td><?php echo $article['good_cert'] ?></td>
                           ...
                           <td><a class="btn btn-info"  href="editgood.php?goodId=<?php echo $article[good_id];?>">Edit</a></td>
                           <td><a class="btn btn-danger"  href="delete.php">Delete</i></a></li></td>
